    ...
    <div class="row">
        <div class="col">
            <button class="btn btn-info" id="btn-add">
                <i class="fa fa-fw fa-plus-circle" aria-hidden="true"></i> Setoran Baru
            </button>
        </div>

        <div class="col">
            <div class="input-group">
                <select class="form-control custom-select" id="deposit-type">
...
@include('include.modal') @endsection @push('js')
<!-- Page level plugins -->
